...
blogs_per_page = settings.BLOGS_PER_PAGE


def blog_with_common_list(request, blogs_all_list):
    paginator = Paginator(blogs_all_list, blogs_per_page)  # 每10篇进行分页
...
def blog_list(request):
    ...
    context = blog_with_common_list(request, blogs_all_list)
